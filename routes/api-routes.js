...
module.exports = function (app) {
    app.get("/api/all", function (request, response) {
        var dbQuery = "SELECT f.FACILITY_NAME, f.FACILITY_ID, f.LATITUDE, f.LONGITUDE, f.FACILITY_COMPLIANCE_REPORT_URL, c.CHEM_NAME_FOR_URL, c.CARCINOGEN, c.CLEAN_AIR, c.HSDB_URL FROM environment_db2.facility_info f LEFT JOIN environment_db2.chemical_info c ON f.FACILITY_ID = c.FACILITY_ID";
